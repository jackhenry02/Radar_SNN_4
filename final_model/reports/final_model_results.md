...
|---|---:|---:|---:|---:|---:|---:|---:|
| Constrained: 0.25-5 m, +/-45 deg | `24` | `0.0310 m` | `6.109 deg` | `0.810 deg` | `0.3285 m` | `0.0533` | `192.92 ms` |
| Expanded: 0-10 m, +/-90 deg | `24` | `0.5556 m` | `15.178 deg` | `2.770 deg` | `1.0439 m` | `0.0850` | `351.88 ms` |
...
| New integrated constrained model | `0.0533` | `0.0310 m` | `6.109 deg` | `0.810 deg` | `0.3285 m` |
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| `16` | `0.0183 m` | `5.009 deg` | `1.491 deg` | `0.2330 m` | `169.54 ms` | `24.98 MFLOP` | `8.00 kSOP` |
| `32` | `0.0175 m` | `3.545 deg` | `0.889 deg` | `0.1844 m` | `177.02 ms` | `26.46 MFLOP` | `16.01 kSOP` |
| `48` | `0.0193 m` | `2.998 deg` | `0.939 deg` | `0.1423 m` | `193.32 ms` | `27.95 MFLOP` | `24.01 kSOP` |
| `96` | `0.0192 m` | `3.266 deg` | `0.932 deg` | `0.1652 m` | `186.39 ms` | `32.39 MFLOP` | `48.02 kSOP` |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `45` | `90` | `0.0212 m` | `3.079 deg` | `0.607 deg` | `0.1401 m` | `112.22 ms` | `10.21 MFLOP` | `15.28 kSOP` |
| `91` | `182` | `0.0193 m` | `2.998 deg` | `0.939 deg` | `0.1423 m` | `203.37 ms` | `28.29 MFLOP` | `24.11 kSOP` |
| `181` | `362` | `0.0202 m` | `3.010 deg` | `1.707 deg` | `0.1791 m` | `452.73 ms` | `98.93 MFLOP` | `41.39 kSOP` |
| `361` | `722` | `0.0208 m` | `3.008 deg` | `1.703 deg` | `0.1804 m` | `1977.19 ms` | `380.16 MFLOP` | `75.95 kSOP` |
