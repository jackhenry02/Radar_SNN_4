...
|---|---:|---:|---:|---:|---:|
| raw | `0.0910 m` | `4.969 deg` | `23.358 deg` | `1.6693 m` | `0.2159` |
...
![Raw vs baseline scatter](../outputs/trainable_readout/figures/train1_val1_test1_envnoise50dB_reverb/raw_vs_baseline_scatter.png)
...
- `raw_vs_baseline_scatter`: `final_model/outputs/trainable_readout/figures/train1_val1_test1_envnoise50dB_reverb/raw_vs_baseline_scatter.png`
