\begin{figure}[htbp]
    ...
    \textbf{\large B}\\[0.5ex]
    \centering
    \includegraphics[width=\linewidth]{3_Modelling/elevation/weights.png}
    \end{subfigure}
    \caption{DCN spectral-cue model. A: receptive-field topology of an arbitrary DCN principal neuron ($\text{DCN}_j$), combining narrow-band central inhibition with broader lateral excitation. B: final signal-weighted DCN synaptic matrix; the boxed legend identifies the first spectral-notch trajectory.}
