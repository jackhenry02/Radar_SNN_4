...
\begin{table}[H]
    ...
    \begin{tabular}{llrrrrr}
        ...
        Noise-free & Fixed calibrated CANN & 0.0366~m & 4.925$^\circ$ & 0.910$^\circ$ & 0.244~m & 0.0457 [0.041, 0.051] \\
         & Direct SNN & 0.0624~m & \textbf{$2.449^\circ$} & 1.133$^\circ$ & 0.161~m & 0.0307 [0.029, 0.033] \\
         & Residual SNN & \textbf{0.0139~m} & 2.619$^\circ$ & \textbf{$0.267^\circ$} & \textbf{0.125~m} & \textbf{0.0223 [0.020, 0.024]} \\
        \midrule
        Environmental noise & Fixed calibrated CANN & 0.0789~m & 8.094$^\circ$ & 26.642$^\circ$ & 1.577~m & 0.2626 [0.246, 0.279] \\
         ...
         & Residual SNN & \textbf{0.0213~m} & \textbf{$3.705^\circ$} & \textbf{$3.505^\circ$} & \textbf{0.297~m} & \textbf{0.0548 [0.051, 0.059]} \\
        \midrule
        Noise + delayed echoes & Fixed calibrated CANN & 0.0799~m & 8.147$^\circ$ & 25.975$^\circ$ & 1.567~m & 0.2581 [0.242, 0.275] \\
         & Direct SNN & 0.0731~m & \textbf{$3.883^\circ$} & 4.028$^\circ$ & 0.343~m & 0.0635 [0.059, 0.068] \\
         & Residual SNN & \textbf{0.0202~m} & 3.898$^\circ$ & \textbf{$3.341^\circ$} & \textbf{0.310~m} & \textbf{0.0550 [0.050, 0.060]} \\
        \bottomrule
    \end{tabular}%
    }
\end{table}
