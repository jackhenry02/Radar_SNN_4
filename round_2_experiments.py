...
from stages.round_2_experiments import run_round_2_experiments
...
def main() -> None:
    ...
    summary = run_round_2_experiments(config, outputs)
    print(
        f"Round 2 experiments complete with max_threads={max_threads}, "
