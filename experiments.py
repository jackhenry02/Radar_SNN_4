...
from stages.experiments import run_experiments
...
def main() -> None:
    ...
    summary = run_experiments(context)
    save_json(
        outputs.root / "experiment_summary.json",
        {
    ...
    print(
        f"Controlled experiments complete with max_threads={max_threads}, device={context.device}, "
