\begin{figure}[htbp]
    ...
    \node (dnll) [block, below=1.0cm of vcn, xshift=1.8cm] {DNLL};
    ...
    \end{tikzpicture}
    \caption{Distance mapping pipeline. The VCN/VNLL stage extracts reliable onsets, the DNLL branch suppresses late repeated responses, and the IC compares the received sweep with the corollary-discharge reference before AC population formation and SC readout.}
