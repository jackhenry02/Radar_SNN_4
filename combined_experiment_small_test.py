...
def main() -> None:
    ...
    summary = run_combined_small_data_test(config, outputs)
    print(
        f"Combined small-data test complete with max_threads={max_threads}, "
        f"dataset_mode={summary['short_data_test']['dataset_mode']}.",
        flush=True,
    )
